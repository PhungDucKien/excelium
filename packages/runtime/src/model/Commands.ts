...
export default {
  ...
  assertNotSelectedValue: {
    ...
    param1: ArgTypes.selectLocator,
    param2: ArgTypes.pattern,
  },
  assertNotText: {
  ...
  elseIf: {
    ...
    param1: ArgTypes.conditionalExpression,
  },
  end: {
    name: 'end',
  ...
  executeScript: {
    ...
    param1: ArgTypes.script,
    param2: ArgTypes.variableName,
  },
  executeAsyncScript: {
  ...
  forEach: {
    ...
    param1: ArgTypes.arrayVariableName,
    param2: ArgTypes.iteratorVariableName,
  },
  if: {
    name: 'if',
  ...
  storeAttribute: {
    ...
    param1: ArgTypes.attributeLocator,
    param2: ArgTypes.variableName,
  },
  storeElementCount: {
