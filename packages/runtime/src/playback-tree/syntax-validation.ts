...
export function validateControlFlowSyntax(commandStack: CommandObject[]) {
  const state = new State();
  commandStack.forEach((command, commandIndex) => {
...
function validateCommand(command: CommandObject, commandIndex: number, state: State) {
