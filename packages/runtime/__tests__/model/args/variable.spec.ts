...
import variable from '../../../src/model/args/variable';
  ...
  describe('verify', () => {
    ...
    describe('property access', () => {
      ...
      it('should throw when trying to access an un-declared property', () => {
        expect(() => variable.validate('tomer..steinfeld')).toThrow('Unexpected token .');
      });

      it('should throw for a variable with an invalid property', () => {
        expect(() => variable.validate('tomer.aå')).toThrow('Unexpected token å');
      });

      it('should throw for variable property starting with a number', () => {
        expect(() => variable.validate('tomer.5a')).toThrow('Unexpected token 5');
      });
    });
    ...
    describe('array access', () => {
      ...
      it('should fail to access an array with an invalid integer index', () => {
        expect(() => variable.validate('tomer[00]')).toThrow('Unexpected token 0');
      });
      it('should not allow two opening brackets', () => {
        expect(() => variable.validate('tomer[[1]')).toThrow('Unexpected token [');
      });
